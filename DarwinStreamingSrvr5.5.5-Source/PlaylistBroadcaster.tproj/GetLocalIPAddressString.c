...
short GetLocalIPAddressString(char *returnStr, short maxSize)
{
    ...
    do 
    {
        ...
        //Most of this code is similar to the SIOCGIFCONF code presented in Stevens, Unix Network Programming, section 16.6
...
//      int numIPAddrs = 0;
        ...
        for (ifReqIter = buffer; ifReqIter < (buffer + ifc.ifc_len);)
        {
            ...
            //Only count interfaces in the AF_INET family. And don't count localhost, loopback interfaces
